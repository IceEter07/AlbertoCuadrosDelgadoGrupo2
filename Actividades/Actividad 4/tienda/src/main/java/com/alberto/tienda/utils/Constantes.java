...
public class Constantes {
    ...
    public static final String MENSAJE_PRODUCTO_ACTUALIZADO_EXISTOSAMENTE = "El producto se actualizo correctamente. El codigo y el ID de la tienda proporcionados coincidieron con registro ya existente en el servidor";
