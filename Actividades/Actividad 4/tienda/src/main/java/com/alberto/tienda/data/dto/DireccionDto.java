...
public class DireccionDto {
    ...
    @Pattern(regexp = "^[A-Za-z ]+$", message = "El nombre del municipio debe contener solo caracteres alfabéticos (se admiten espacios)")
    ...
    @Pattern(regexp = "^[A-Za-z ]+$", message = "El nombre de la colonia debe contener solo caracteres alfabéticos (se admiten espacios)")
    ...
    @Pattern(regexp = "^[A-Za-z ]+$", message = "El nombre de la calle debe contener solo caracteres alfabéticos (se admiten espacios)")
